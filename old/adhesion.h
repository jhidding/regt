...
#include "../libconan/conan/boxconfig.h"
#include "../libconan/conan/mvector.h"
#include "../libconan/spaces/gridspace.h"
#include "../libconan/interpol/interpol.h"
#include "progress.h"
...
//		void print_dual__(std::ostream &out, RT const &rt) const
//		{
//			for (typename RT::Finite_edges_iterator i = rt.finite_edges_begin();
//				i != rt.finite_edges_end(); ++i)
//			{
//				CGAL::Object o = rt.dual(i);
//				RT::Segment e;
//				if (CGAL::assign(e, o))
//					out << e.start() << "\n" << e.end() << "\n\n";
//			}
//		}
//
//		void thou_shalt_make_loops(std::function<void (Point const &, double)> const &f)
//		{
...
//		
//		
//		int face_cnt(typename RT::Face_handle f)
//		{
...
//		}
//
//		void for_each_dual_segment(std::function<void (Segment const &, int, double)> const &f)
//		{
//			std::for_each(
//				rt->finite_edges_begin(),
//				rt->finite_edges_end(),
//				[&, this] (typename RT::Edge const &e)
//			{
...
//				{
//					int cnt = 0;
//					cnt += this->face_cnt(e.first);
//					cnt += this->face_cnt(rt->mirror_edge(e).first);
//
//					f(s, (rt->segment(e).squared_length() > 3.0 ? cnt : 0), rt->segment(e).squared_length());
//				}
//			});
//		}
//
//		
//		void for_each_big_triangle(std::function<void (Triangle const &, int)> const &f)
//		{
...
//				for (unsigned j = 0; j < 3; ++j)
//				{
//					if (rt->segment(i, j).squared_length() > 3.0)
//						++c;
//				}
//				
//				if (c > 0) f(t, c);
...
//		}
//		
//		void for_each_hidden_vertex(std::function<void (Point const &)> const &f)
//		{
//			for (auto i = rt->hidden_vertices_begin();
//				i != rt->hidden_vertices_end(); ++i)
//			{
//				f(i->point());
//			}
//		}
